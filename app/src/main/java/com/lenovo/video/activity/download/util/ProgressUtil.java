...
public class ProgressUtil {
    ...
    public static void updateProgressToViewWithMark(ProgressBar bar, long currentOffset, boolean anim) {
        if (bar.getTag() == null) {
            return;
        }
    ...
    public static void calcProgressToViewAndMark(ProgressBar bar, long offset, long total, boolean anim) {
        ...
        final int shrinkRate = contentLengthOnInt == 0 ? 1 : (int) (total / contentLengthOnInt);
